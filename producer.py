...
# # producer.py - Sends to Kinesis AND Saves to S3/raw/
# import json
# import time
# import boto3
...
#     # 2. Save raw data to S3 (for batch layer)
#     s3_key = f"raw/{trade['trade_id']}.json"
#     s3.put_object(
#         Bucket=S3_BUCKET,
#         Key=s3_key,
...
#     print(f"Sent: {trade['product']} | ${trade['price']} (Saved to S3 raw/)")
