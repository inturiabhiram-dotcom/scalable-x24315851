...
# # app.py - Fixed: NO fallback to speed data for batch
...
#     windows = []
#     try:
#         response = s3.list_objects_v2(Bucket=S3_BUCKET, Prefix=f'window/{product}/', MaxKeys=10)
#         if 'Contents' not in response:
#             return windows
...
# @app.route("/api/batch")
# def batch():
#     """BATCH LAYER - ONLY from S3/batch/batch_summary.json"""
#     try:
#         product = request.args.get('product', 'BTC-USD')
...
#         # ✅ CORRECT: Return empty data with message, NOT speed data!
#         return jsonify({
#             "product": product,
#             "trades": 0,
#             "avg_price": 0,
...
# def merged():
#     """Merged data - Speed + Batch + Windows"""
#     try:
#         product = request.args.get('product', 'BTC-USD')
